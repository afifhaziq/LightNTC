...
logging.basicConfig(filename='C:\\Users\\afif\\Documents\\Master\\Code\\LightNTC\\Pre-process\\error.log', level=logging.ERROR,
...
inputPath = "D:\\ISCX-01-03-combined\\"
outputPath = "D:\\ISCX-Done\\"

c1details = {"filename": "skype_video1a",
             "fileExtension" : ".pcap",
             "label" : "skypevideo"}
...
if __name__ == '__main__': 
    ...
    df1.to_csv(c1details["output"], index=False)
    df2.to_csv(c2details["output"], index=False)
